                ...
                <div class="col-lg-4">
                    <div class="left-content">
                        <div class="inner-content">
                            <h4 class="text-white">Flash Coffee</h4>
                            <h6>THE BEST EXPERIENCE</h6>
                            <div class="main-white-button scroll-to-section">
                                <a href="{{route('reservation.step.one')}}">Make A Reservation</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>Flash Coffee adalah jaringan outlet kopi berkonsep teknologi yang menawarkan pengalaman ngopi yang berbeda dengan kopi premium dan harga yang terjangkau.
                            <br><br>You are NOT allowed to redistribute the template ZIP file on any template donwnload website. Please contact us for more information.</p>
                        <div class="row">
                            <div class="col-4">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-content">
                        <div class="thumb">
                            <a rel="nofollow" href="https://www.youtube.com/watch?v=BBEOP2qJsDI"><i class="fa fa-play"></i></a>
